...
public:
	...
	static clr_t rainbow( float t ) {
		return clr_t(
			( uint8_t )( ::floorf( ::sinf( t + 0.f ) * 127.f + 128.f ) ),
			( uint8_t )( ::floorf( ::sinf( t + 2.f ) * 127.f + 128.f ) ),
			( uint8_t )( ::floorf( ::sinf( t + 4.f ) * 127.f + 128.f ) ),
			255
		);
	};
	...
	clr_t& operator=( const clr_t& rhs ) {
