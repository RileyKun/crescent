...
public:
	...
	virtual void SetAmbientLightCube(vec4_t cube[6]) = 0;
	...
	virtual void LoadMatrix(vmatrix_t const& matrix) = 0;
	virtual void LoadMatrix(matrix3x4_t const& matrix) = 0;
	virtual void MultMatrix(vmatrix_t const& matrix) = 0;
	virtual void MultMatrix(matrix3x4_t const& matrix) = 0;
	virtual void MultMatrixLocal(vmatrix_t const& matrix) = 0;
	virtual void MultMatrixLocal(matrix3x4_t const& matrix) = 0;
	virtual void GetMatrix(MaterialMatrixMode_t matrixMode, vmatrix_t* matrix) = 0;
	...
	virtual void SetFlashlightState(const FlashlightState_t& state, const vmatrix_t& worldToTexture) = 0;
	...
	virtual void UserClipTransform(const vmatrix_t& worldToView) = 0;
	...
	virtual void SetFlashlightStateEx(const FlashlightState_t& state, const vmatrix_t& worldToTexture, ITexture* pFlashlightDepthTexture) = 0;
	...
	virtual bool GetMorphAccumulatorTexCoord(vec2_t* pTexCoord, IMorph* pMorph, int nVertex) = 0;
