...
void bf_write::WriteBitVec3Coord(const vec3_t& fa)
{
...
void bf_write::WriteBitVec3Normal(const vec3_t& fa)
{
	int		xflag, yflag;
...
void bf_write::WriteBitAngles(const vec3_t& fa)
{
	// FIXME:
	vec3_t tmp(fa.x, fa.y, fa.z);
...
void bf_read::ReadBitVec3Coord(vec3_t& fa)
{
	int		xflag, yflag, zflag;
...
void bf_read::ReadBitVec3Normal(vec3_t& fa)
{
...
void bf_read::ReadBitAngles(vec3_t& fa)
{
	vec3_t tmp;
